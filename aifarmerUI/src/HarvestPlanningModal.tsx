...
const HarvestPlanningModal: React.FC<HarvestPlanningModalProps> = ({ show, onClose, crops, categories }) => {
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <h2 style={{ color: "#16a34a", fontWeight: 700, fontSize: 24, margin: 0 }}>🌾 Harvest Planning</h2>
              ...
              {filteredCrops.map((crop, idx) => (
                ...
                >
                  ...
                  <div style={{background: '#f0fdf4', borderRadius: 8, padding: '10px 14px', marginBottom: 10}}>
                    <span style={{fontWeight: 600, color: '#15803d'}}>🗓️ Harvest Planning:</span>
                  ...
                  {/* Direct link if available (for demo, link to Google search for crop harvest planning) */}
                  <a
                    href={`https://www.google.com/search?q=${encodeURIComponent(crop.name + ' harvest planning')}`}
                    target="_blank"
